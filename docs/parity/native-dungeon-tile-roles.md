...
Source commit `df65f40a` passed the full cold route: 1,581,079 consecutive
exact audio/video frames in 2,400.48 seconds (40.0 minutes), starting at
...
`routes/full_run/receipts/roles-full-av.manifest.json`.
