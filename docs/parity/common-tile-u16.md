...
Source commit `29309023` passed the full cold route: 1,581,079 consecutive
exact audio/video frames in about 2459 seconds (41.0 minutes), starting at
...
`routes/full_run/receipts/cast-full-av.manifest.json`.
