...
Source commit `07aa5fb3` passed the full cold route: 1,581,079 consecutive
exact audio/video frames in about 2464 seconds (41.1 minutes), starting at
...
`routes/full_run/receipts/tables-full-av.manifest.json`.
