...
Source commit `e403eca3` passed the full cold route: 1,581,079 consecutive
exact audio/video frames in 2,449.72 seconds (40.8 minutes), starting at
...
All four WRAM goldens (60,000, 150,470, 500,000, and 732,000) match with no
differing bytes, and the full 131,072-byte final WRAM image is identical to
the preceding promoted build, SHA-256
`316193798ccb2f771546b25443df7d417bddac8a7cac65326fa189c1264fbdb6`.
The promoted receipt is
`routes/full_run/receipts/owners-full-av.manifest.json`.
