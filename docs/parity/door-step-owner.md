...
Source commit `a6377ce8` passed the full cold route: 1,581,079 consecutive
exact audio/video frames in about 2469 seconds (41.1 minutes), starting at
...
`routes/full_run/receipts/door-full-av.manifest.json`.
