...
Source commit `a5663aa8` passed the full cold route: 1,581,079 consecutive
exact audio/video frames in about 2462 seconds (41.0 minutes), starting at
...
`routes/full_run/receipts/dups-full-av.manifest.json`.
