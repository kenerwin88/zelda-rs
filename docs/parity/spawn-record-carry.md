...
Source commit `de4366db` passed the full cold route: 1,581,079 consecutive
exact audio/video frames in about 2443 seconds (40.7 minutes), starting at
...
`routes/full_run/receipts/spawn-full-av.manifest.json`.
