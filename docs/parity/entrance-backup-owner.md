...
Source commit `6538f513` passed the full cold route: 1,581,079 consecutive
exact audio/video frames in 2,520.58 seconds (42.0 minutes), starting at
...
`routes/full_run/receipts/entrance-full-av.manifest.json`.
