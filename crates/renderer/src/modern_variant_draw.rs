...
fn trace_bg_packet_pixel(
    ...
    Some(VariantPixelTrace {
        ...
        source_x,
        source_y,
        cell_hflip: packet.cell.hflip,
        cell_vflip: packet.cell.vflip,
        entry_hflip: source_hflip,
...
fn trace_sprite_packet_pixel(
    ...
    VariantPixelTrace {
        ...
        source_x,
        source_y,
        cell_hflip: packet.inst.hflip,
        cell_vflip: packet.inst.vflip,
        entry_hflip: source_hflip,
        entry_vflip: source_vflip,
        palette_row: packet.inst.palette,
        palette_index,
