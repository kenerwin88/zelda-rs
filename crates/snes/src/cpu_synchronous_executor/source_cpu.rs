...
impl SourceCpuInstructionBus for Snes9xColdCpuExecutor {
    ...
    fn immediate8(
        ...
        Snes9xColdCpuExecutor::immediate8(self, update_open_bus, accesses)
    }
    ...
    fn immediate16(
        ...
        Snes9xColdCpuExecutor::immediate16(self, update_open_bus, accesses)
    }
    ...
    fn immediate16_slow(
        ...
        Snes9xColdCpuExecutor::immediate16_slow(self, update_open_bus, accesses)
    }
    ...
    fn absolute_long_address(
        ...
        Snes9xColdCpuExecutor::absolute_long_address(self, update_open_bus, accesses)
    }
    ...
    fn read_byte(
        ...
        Snes9xColdCpuExecutor::read_byte(self, address, accesses)
    }
    ...
    fn write_byte(
        ...
        Snes9xColdCpuExecutor::write_byte(self, address, value, accesses)
    }
    ...
    fn read_word(
        ...
        Snes9xColdCpuExecutor::read_word(self, address, wrap, accesses)
    }
    ...
    fn write_word(
        ...
        Snes9xColdCpuExecutor::write_word(self, address, value, wrap, order, accesses)
    }

    fn add_cycles(&mut self, cycles: u32) -> Result<(), SourceCpuError> {
        Snes9xColdCpuExecutor::add_cycles(self, cycles)
    }
}
