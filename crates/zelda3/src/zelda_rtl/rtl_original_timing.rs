...
impl ZeldaState {
    ...
    pub(super) fn run_frame_internal_after_original_timing_body(
        ...
        let authoritative_item_receipt_returned = if authoritative_item_receipt_is_active {
            ...
            match work_slice {
                ...
                GameWorkStep::Complete(
                    ...
                    match work {
                        ...
                        DungeonSupertileTransitionWork::AuxiliarySpriteGraphics => {
                            ...
                            let wire_sprite_main_in_host = matches!(
                                self.original_timing_owner,
                                OriginalTimingOwnerState::Live
                            ) && (self.original_timing_owes_sprite_main_return()
                                || authoritative_supertile_sprite_main_returned
                        ...
                        DungeonSupertileTransitionWork::SpriteConversion => {
                            ...
                            if schedule.caller_sprite_main_nmis != 0 {
                                    ...
                                    cached_sprite_interruption
                                {
                                    ...
                                    self.sprite_main_cpu_nmi_slices =
                                        schedule.caller_sprite_main_nmis;
                                }
                                self.complete_module07_dungeon_after_submodule();
                                debug_assert!(self
                        ...
                        DungeonSupertileTransitionWork::SpiralSpriteGraphics => {
                            ...
                            let wire_interrupts_caller_suffix = schedule.caller_sprite_main_nmis
                                == 0
                                && authoritative_scheduled_caller_nmi_timeline.is_some_and(
                                    |timeline| {
                                        timeline.progress
                ...
                GameWorkStep::Complete(GameWorkContinuation::FinishPreDungeonEntranceLoad {
                        ...
                        )
                    {
                        ...
                        self.zelda_run_game_loop_with_progress(Some(
                            crate::MainLoopProgress::IterationStarted,
                        ));
                ...
                GameWorkStep::Complete(GameWorkContinuation::FinishSpriteMain {
                    ...
                    // claim to consume.
                    let scheduled_return_sprite_main_claims =
                        authoritative_scheduled_caller_return_timeline
                            .as_ref()
                            .map(|(_, _, claims)| *claims)
                        ...
                        match caller {
                            SpriteMainCpuCaller::DungeonModule07 => {
                                let sprite_return = self
                                    ...
                                    .take()
                                    .expect(
                                    "Sprite_Main continuation must retain Module 7 return state",
                                );
                                self.complete_module07_after_sprite_main(sprite_return);
                            ...
                            SpriteMainCpuCaller::DungeonModule07Live { .. } => {
                                let sprite_return = self
                                    ...
                                    .take()
                                    .expect(
                                        "live Sprite_Main continuation must retain Module 7 return state",
                                    );
                                self.complete_module07_after_sprite_main(sprite_return);
                                if live_nonterminal_dungeon {
                                    self.complete_parked_dungeon_sprite_main_suffix_by_wire(true);
                            ...
                            SpriteMainCpuCaller::Module09 { .. } => {
                                let module09 = self
                                    ...
                                    .take()
                                    .expect(
                                        "live Sprite_Main continuation must retain Module09 return state",
                                    );
                ...
                GameWorkStep::Complete(GameWorkContinuation::FinishDungeonExitSpotlightEntry {
                    ...
                    match link_position_interruption {
                        Some(crate::MainLoopInterruption::LinkActualVelocity { horizontal_resolved }) => {
                    ...
                    self.set_next_display_obj_scanout(Some(
                        dungeon_exit_spotlight_entry_return_obj_scanout(),
                    ));
                }
                GameWorkStep::Complete(GameWorkContinuation::FinishDungeonExitSpotlightBuild {
                    table_build,
                    ...
                    if let Some(interruption) = link_position_interruption {
                        ...
                        match interruption {
                            crate::MainLoopInterruption::LinkActualVelocity { horizontal_resolved } => self
                            ...
                            crate::MainLoopInterruption::DungeonExitSpotlightTableCompleted => self.complete_dungeon_exit_spotlight_build_until_control(table_build, projection_completed, iteration),
                ...
                GameWorkStep::Complete(GameWorkContinuation::FinishGameOverSpotlightBuild {
                    ...
                    let wire_defers_caller_return = authoritative_scheduled_caller_return_timeline
                        .is_none()
                        && authoritative_scheduled_caller_nmi_timeline.is_some_and(|timeline| {
                            timeline.progress == crate::MainLoopProgress::CallStackContinued
                                && matches!(
                ...
                GameWorkStep::Complete(GameWorkContinuation::FinishWorldMapOverlayReload) => {
                    ...
                    let claimed_sprite_main_boundary =
                        self.take_original_timing_sprite_main_progress();
                    self.finish_overworld_load_overlays();
                    assert_eq!(
                        schedule.caller_nmis,
                    ...
                    if schedule.caller_sprite_main_nmis != 0 {
                        ...
                        let authoritative_phase = self.take_authoritative_module09_caller_phase(
                            schedule.caller_first_nmi_phase,
                        );
                        match authoritative_phase {
                            ...
                            phase => panic!(
                                "Module09/$20 caller crossed an unsupported semantic phase: {phase:?}"
                            ),
                        }
                    }
                }
                ...
                GameWorkStep::Complete(GameWorkContinuation::FinishOverworldSpriteReloadTail {
                        ...
                        .work_suspends_translated_call_stack()
                    {
                        let caller = self
                            ...
                            .as_mut()
                            .expect(
                                "interrupted overworld reload must retain its Module09 Sprite_Main frame",
                            );
                        assert_eq!(
