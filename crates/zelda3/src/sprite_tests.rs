...
#[test]
fn mirror_portal_reset_preserves_coordinates_until_the_spawn_returns() {
    for completed_stores in 0..=40 {
        let setup = || {
            let mut s = fresh_state();
        ...
        resumed.sprite_begin_mirror_portal_reset(15, completed_stores);
        assert_eq!(resumed.sprite_get_x(15), 0x0078);
        assert_eq!(resumed.sprite_get_y(15), 0x137c);
        resumed.sprite_resume_mirror_portal_reset(15, completed_stores);
