...
fn run_compare_bootstrap_apu_startup(args: &[String]) {
    ...
    for _ in 0..frames {
        run_play_frame(&mut game, 0, &mut frame, render_flags);
...
struct VariantLiveStats {
    ...
    cpu_screen_builder_block_forced_blank: u64,
    cpu_screen_builder_block_window: u64,
    cpu_screen_builder_block_mosaic: u64,
    cpu_screen_builder_block_bg4: u64,
    cpu_screen_builder_block_short_bg_layers: u64,
    cpu_screen_builder_block_scroll: u64,
...
impl VariantLiveStats {
    ...
    fn record(&mut self, stats: renderer::modern_software::VariantAtlasRenderStats) {
        ...
        self.cpu_screen_builder_block_forced_blank +=
            u64::from(stats.cpu_screen_builder_block_forced_blank);
        self.cpu_screen_builder_block_window += u64::from(stats.cpu_screen_builder_block_window);
        self.cpu_screen_builder_block_mosaic += u64::from(stats.cpu_screen_builder_block_mosaic);
        self.cpu_screen_builder_block_bg4 += u64::from(stats.cpu_screen_builder_block_bg4);
        self.cpu_screen_builder_block_short_bg_layers +=
            u64::from(stats.cpu_screen_builder_block_short_bg_layers);
        self.cpu_screen_builder_block_scroll += u64::from(stats.cpu_screen_builder_block_scroll);
        ...
        if self.frames % self.log_every_frames == 0 {
            eprintln!(
                ...
                self.cpu_screen_builder_block_forced_blank,
                self.cpu_screen_builder_block_window,
                self.cpu_screen_builder_block_mosaic,
                self.cpu_screen_builder_block_bg4,
                self.cpu_screen_builder_block_short_bg_layers,
                self.cpu_screen_builder_block_scroll,
...
impl GpuPlayRenderer {
    fn new() -> Self {
        ...
        let source_atlas = load_source_atlas_for_mode(&mode, Path::new(".")).unwrap_or_else(|e| {
...
fn run_replay_save(args: &[String]) {
    ...
    let mut modern_index_compare_live_index_draws = 0u64;
    let mut modern_index_compare_live_index_bg_draws = 0u64;
    let mut modern_index_compare_live_index_bg12_draws = 0u64;
    let mut modern_index_compare_live_index_bg3_draws = 0u64;
    let mut modern_index_compare_live_index_sprite_draws = 0u64;
    let mut modern_index_compare_gpu_prefinal_base_frames = 0u64;
    let mut modern_index_compare_gpu_screen_builder_frames = 0u64;
    let mut modern_index_compare_cpu_prefinal_composite_frames = 0u64;
    let mut modern_index_compare_cpu_prefinal_overlay_frames = 0u64;
    let mut modern_index_compare_cpu_screen_builder_block_forced_blank = 0u64;
    let mut modern_index_compare_cpu_screen_builder_block_window = 0u64;
    let mut modern_index_compare_cpu_screen_builder_block_mosaic = 0u64;
    let mut modern_index_compare_cpu_screen_builder_block_bg4 = 0u64;
    let mut modern_index_compare_cpu_screen_builder_block_short_bg_layers = 0u64;
    let mut modern_index_compare_cpu_screen_builder_block_scroll = 0u64;
    ...
    let mut modern_index_compare_effect_material_draws = 0u64;
    let mut modern_index_compare_dynamic_material_fallback_draws = 0u64;
    let mut modern_index_compare_dynamic_material_fallback_instance_source_draws = 0u64;
    let mut modern_index_compare_dynamic_material_fallback_brightness_draws = 0u64;
    let mut modern_index_compare_dynamic_material_fallback_policy_draws = 0u64;
    let mut modern_index_compare_dynamic_material_fallback_missing_effect_draws = 0u64;
    let mut modern_index_compare_dynamic_material_fallback_unsupported_draws = 0u64;
    let mut modern_index_compare_unsupported_material_draws = 0u64;
    let mut modern_index_compare_missing_art_draws = 0u64;
    let mut modern_index_compare_unkeyed_fallback_draws = 0u64;
    let mut modern_index_compare_unkeyed_bg_fallback_draws = 0u64;
    let mut modern_index_compare_unkeyed_bg12_fallback_draws = 0u64;
    let mut modern_index_compare_unkeyed_bg3_fallback_draws = 0u64;
    let mut modern_index_compare_unkeyed_sprite_fallback_draws = 0u64;
    let mut modern_index_compare_mixed_overlay_bg_effect_draws = 0u64;
    let mut modern_index_compare_mixed_overlay_bg_effect_candidates = 0u64;
    let mut modern_index_compare_mixed_overlay_bg_effect_culled_invisible_main = 0u64;
    let mut modern_index_compare_mixed_overlay_bg_effect_reject_complex_frame = 0u64;
    let mut modern_index_compare_mixed_overlay_bg_effect_reject_complex_brightness = 0u64;
    let mut modern_index_compare_mixed_overlay_bg_effect_reject_complex_invalid_layer = 0u64;
    let mut modern_index_compare_mixed_overlay_bg_effect_reject_complex_mosaic = 0u64;
    let mut modern_index_compare_mixed_overlay_bg_effect_reject_complex_sub_window = 0u64;
    let mut modern_index_compare_mixed_overlay_bg_effect_reject_complex_effect_bounds = 0u64;
    let mut modern_index_compare_mixed_overlay_bg_effect_reject_complex_scanline_main = 0u64;
    let mut modern_index_compare_mixed_overlay_bg_effect_reject_complex_layer_window = 0u64;
    let mut modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math = 0u64;
    ...
    let mut modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap =
        0u64;
    let mut
    modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg =
        0u64;
    let mut
    modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_obj =
        0u64;
    let mut
    modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_deeper_chain =
        0u64;
    let mut
    modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front =
        0u64;
    let mut
    modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_mixed_static_live_order =
        0u64;
    let mut
    modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front_no_effect =
        0u64;
    let mut
    modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front_complex =
        0u64;
    let mut
    modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front_cgram_mismatch =
        0u64;
            ...
            if let Some(mode_label) = mode_str {
                    ...
                    modern_variant_headless.as_ref()
                {
                    if gpu_frame.mode == 7 {
                        ...
                        if let Some((trace_frame, trace_x, trace_y)) = variant_trace_pixel_env() {
                            if frames == trace_frame {
                                ...
                                if traces.is_empty() {
                                    eprintln!(
                                        "variant_pixel_trace frame={frames} pixel=({trace_x}, {trace_y}) hits=0"
                                    );
                                } else {
                                    for trace in traces {
                                        eprintln!(
                                            "variant_pixel_trace frame={frames} pixel=({trace_x}, {trace_y}) {}",
                                            trace.describe()
                                        );
                                    }
                                }
                        ...
                        let (rgba, stats) = variant_headless.render_rgba_with_live_index_base(
                            &modern,
                            &bg_cells,
                            &sprite_cells,
                            &live_index_modern,
                ...
                if let Some(stats) = variant_stats {
                    ...
                    modern_index_compare_live_index_draws += u64::from(stats.live_index_draws);
                    modern_index_compare_live_index_bg_draws +=
                        u64::from(stats.live_index_bg_draws);
                    modern_index_compare_live_index_bg12_draws +=
                        u64::from(stats.live_index_bg12_draws);
                    modern_index_compare_live_index_bg3_draws +=
                        u64::from(stats.live_index_bg3_draws);
                    modern_index_compare_live_index_sprite_draws +=
                        u64::from(stats.live_index_sprite_draws);
                    modern_index_compare_gpu_prefinal_base_frames +=
                        u64::from(stats.gpu_prefinal_base_frames);
                    modern_index_compare_gpu_screen_builder_frames +=
                        u64::from(stats.gpu_screen_builder_frames);
                    modern_index_compare_cpu_prefinal_composite_frames +=
                        u64::from(stats.cpu_prefinal_composite_frames);
                    modern_index_compare_cpu_prefinal_overlay_frames +=
                        u64::from(stats.cpu_prefinal_overlay_frames);
                    modern_index_compare_cpu_screen_builder_block_forced_blank +=
                        u64::from(stats.cpu_screen_builder_block_forced_blank);
                    modern_index_compare_cpu_screen_builder_block_window +=
                        u64::from(stats.cpu_screen_builder_block_window);
                    modern_index_compare_cpu_screen_builder_block_mosaic +=
                        u64::from(stats.cpu_screen_builder_block_mosaic);
                    modern_index_compare_cpu_screen_builder_block_bg4 +=
                        u64::from(stats.cpu_screen_builder_block_bg4);
                    modern_index_compare_cpu_screen_builder_block_short_bg_layers +=
                        u64::from(stats.cpu_screen_builder_block_short_bg_layers);
                    modern_index_compare_cpu_screen_builder_block_scroll +=
                        u64::from(stats.cpu_screen_builder_block_scroll);
                    ...
                    modern_index_compare_effect_material_draws +=
                        u64::from(stats.effect_material_draws);
                    modern_index_compare_dynamic_material_fallback_draws +=
                        u64::from(stats.dynamic_material_fallback_draws);
                    modern_index_compare_dynamic_material_fallback_instance_source_draws +=
                        u64::from(stats.dynamic_material_fallback_instance_source_draws);
                    modern_index_compare_dynamic_material_fallback_brightness_draws +=
                        u64::from(stats.dynamic_material_fallback_brightness_draws);
                    modern_index_compare_dynamic_material_fallback_policy_draws +=
                        u64::from(stats.dynamic_material_fallback_policy_draws);
                    modern_index_compare_dynamic_material_fallback_missing_effect_draws +=
                        u64::from(stats.dynamic_material_fallback_missing_effect_draws);
                    modern_index_compare_dynamic_material_fallback_unsupported_draws +=
                        u64::from(stats.dynamic_material_fallback_unsupported_draws);
                    modern_index_compare_unsupported_material_draws +=
                        u64::from(stats.unsupported_material_draws);
                    ...
                    modern_index_compare_unkeyed_bg_fallback_draws +=
                        u64::from(stats.unkeyed_bg_fallback_draws);
                    modern_index_compare_unkeyed_bg12_fallback_draws +=
                        u64::from(stats.unkeyed_bg12_fallback_draws);
                    modern_index_compare_unkeyed_bg3_fallback_draws +=
                        u64::from(stats.unkeyed_bg3_fallback_draws);
                    modern_index_compare_unkeyed_sprite_fallback_draws +=
                        u64::from(stats.unkeyed_sprite_fallback_draws);
                    modern_index_compare_mixed_overlay_bg_effect_draws +=
                        u64::from(stats.mixed_overlay_bg_effect_draws);
                    modern_index_compare_mixed_overlay_bg_effect_candidates +=
                        u64::from(stats.mixed_overlay_bg_effect_candidates);
                    modern_index_compare_mixed_overlay_bg_effect_culled_invisible_main +=
                        u64::from(stats.mixed_overlay_bg_effect_culled_invisible_main);
                    modern_index_compare_mixed_overlay_bg_effect_reject_complex_frame +=
                        u64::from(stats.mixed_overlay_bg_effect_reject_complex_frame);
                    modern_index_compare_mixed_overlay_bg_effect_reject_complex_brightness +=
                        u64::from(stats.mixed_overlay_bg_effect_reject_complex_brightness);
                    modern_index_compare_mixed_overlay_bg_effect_reject_complex_invalid_layer +=
                        u64::from(stats.mixed_overlay_bg_effect_reject_complex_invalid_layer);
                    modern_index_compare_mixed_overlay_bg_effect_reject_complex_mosaic +=
                        u64::from(stats.mixed_overlay_bg_effect_reject_complex_mosaic);
                    modern_index_compare_mixed_overlay_bg_effect_reject_complex_sub_window +=
                        u64::from(stats.mixed_overlay_bg_effect_reject_complex_sub_window);
                    modern_index_compare_mixed_overlay_bg_effect_reject_complex_effect_bounds +=
                        u64::from(stats.mixed_overlay_bg_effect_reject_complex_effect_bounds);
                    modern_index_compare_mixed_overlay_bg_effect_reject_complex_scanline_main +=
                        u64::from(stats.mixed_overlay_bg_effect_reject_complex_scanline_main);
                    modern_index_compare_mixed_overlay_bg_effect_reject_complex_layer_window +=
                        u64::from(stats.mixed_overlay_bg_effect_reject_complex_layer_window);
                    modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math +=
                        u64::from(stats.mixed_overlay_bg_effect_reject_complex_color_math);
                    modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_clip +=
                        u64::from(stats.mixed_overlay_bg_effect_reject_complex_color_math_clip);
                    modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_subscreen +=
                        u64::from(stats.mixed_overlay_bg_effect_reject_complex_color_math_subscreen);
                    ...
                    modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg += u64::from(
                        stats.mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg,
                    );
                    modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_obj += u64::from(
                        stats.mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_obj,
                    );
                    modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_deeper_chain += u64::from(
                        stats.mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_deeper_chain,
                    );
                    modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front += u64::from(
                        stats.mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front,
                    );
                    modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_mixed_static_live_order += u64::from(
                        stats.mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_mixed_static_live_order,
                    );
                    modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front_no_effect += u64::from(
                        stats.mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front_no_effect,
                    );
                    modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front_complex += u64::from(
                        stats.mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front_complex,
                    );
                    modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front_cgram_mismatch += u64::from(
                        stats.mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front_cgram_mismatch,
                    );
                ...
                if !modern_index_compare_summary || mismatch != 0 {
                    if let Some(stats) = variant_stats {
                        println!(
                            "modern_index_compare frame={frames} mode={mode_label} ppumode={} mismatch_px={mismatch} via={via} variant_draws={} fallback_draws={} live_index_draws={} live_index_bg_draws={} live_index_bg12_draws={} live_index_bg3_draws={} live_index_sprite_draws={} gpu_prefinal_base_frames={} direct_gpu_fallback_frames={} gpu_screen_builder_frames={} cpu_prefinal_composite_frames={} cpu_prefinal_overlay_frames={} cpu_screen_builder_block_forced_blank={} cpu_screen_builder_block_window={} cpu_screen_builder_block_mosaic={} cpu_screen_builder_block_bg4={} cpu_screen_builder_block_short_bg_layers={} cpu_screen_builder_block_scroll={} dynamic_palette_draws={} missing_variant_draws={} stable_preview_draws={} stable_effect_draws={} dynamic_material_draws={} effect_material_draws={} dynamic_material_fallback_draws={} dynamic_material_fallback_instance_source_draws={} dynamic_material_fallback_brightness_draws={} dynamic_material_fallback_policy_draws={} dynamic_material_fallback_missing_effect_draws={} dynamic_material_fallback_unsupported_draws={} unsupported_material_draws={} missing_art_draws={} unkeyed_fallback_draws={} unkeyed_bg_fallback_draws={} unkeyed_bg12_fallback_draws={} unkeyed_bg3_fallback_draws={} unkeyed_sprite_fallback_draws={} mixed_overlay_bg_effect_draws={} mixed_overlay_bg_effect_candidates={} mixed_overlay_bg_effect_culled_invisible_main={} mixed_overlay_bg_effect_reject_complex_frame={} mixed_overlay_bg_effect_reject_complex_brightness={} mixed_overlay_bg_effect_reject_complex_invalid_layer={} mixed_overlay_bg_effect_reject_complex_mosaic={} mixed_overlay_bg_effect_reject_complex_sub_window={} mixed_overlay_bg_effect_reject_complex_effect_bounds={} mixed_overlay_bg_effect_reject_complex_scanline_main={} mixed_overlay_bg_effect_reject_complex_layer_window={} mixed_overlay_bg_effect_reject_complex_color_math={} mixed_overlay_bg_effect_reject_complex_color_math_clip={} mixed_overlay_bg_effect_reject_complex_color_math_subscreen={} mixed_overlay_bg_effect_reject_complex_color_math_fixed_color={} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_cgram_mismatch={} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap={} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg={} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_obj={} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_deeper_chain={} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front={} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_mixed_static_live_order={} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front_no_effect={} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front_complex={} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front_cgram_mismatch={} mixed_overlay_bg_effect_reject_cgram_mismatch={} mixed_overlay_bg_effect_reject_overlap={}",
                            gpu_frame.mode,
                            stats.stable_draws,
                            stats.fallback_draws,
                            stats.live_index_draws,
                            stats.live_index_bg_draws,
                            stats.live_index_bg12_draws,
                            stats.live_index_bg3_draws,
                            stats.live_index_sprite_draws,
                            stats.gpu_prefinal_base_frames,
                            stats.gpu_prefinal_base_frames,
                            stats.gpu_screen_builder_frames,
                            stats.cpu_prefinal_composite_frames,
                            stats.cpu_prefinal_overlay_frames,
                            stats.cpu_screen_builder_block_forced_blank,
                            stats.cpu_screen_builder_block_window,
                            stats.cpu_screen_builder_block_mosaic,
                            stats.cpu_screen_builder_block_bg4,
                            ...
                            stats.unsupported_material_draws,
                            stats.missing_art_draws,
                            stats.unkeyed_fallback_draws,
                            stats.unkeyed_bg_fallback_draws,
                            stats.unkeyed_bg12_fallback_draws,
                            stats.unkeyed_bg3_fallback_draws,
                            stats.unkeyed_sprite_fallback_draws,
                            stats.mixed_overlay_bg_effect_draws,
                            stats.mixed_overlay_bg_effect_candidates,
                            stats.mixed_overlay_bg_effect_culled_invisible_main,
                            stats.mixed_overlay_bg_effect_reject_complex_frame,
    ...
    if modern_index_compare != 0 && modern_index_compare_summary {
        println!(
            "modern_index_compare_summary compare_count={modern_index_compare_count} bad_count={modern_index_compare_bad_count} bad_pixels={modern_index_compare_bad_pixels} gpu_count={modern_index_compare_gpu_count} mode7_gpu_count={modern_index_compare_mode7_gpu_count} cpu_count={modern_index_compare_cpu_count} variant_draws={modern_index_compare_variant_draws} fallback_draws={modern_index_compare_fallback_draws} live_index_draws={modern_index_compare_live_index_draws} live_index_bg_draws={modern_index_compare_live_index_bg_draws} live_index_bg12_draws={modern_index_compare_live_index_bg12_draws} live_index_bg3_draws={modern_index_compare_live_index_bg3_draws} live_index_sprite_draws={modern_index_compare_live_index_sprite_draws} gpu_prefinal_base_frames={modern_index_compare_gpu_prefinal_base_frames} direct_gpu_fallback_frames={modern_index_compare_gpu_prefinal_base_frames} gpu_screen_builder_frames={modern_index_compare_gpu_screen_builder_frames} cpu_prefinal_composite_frames={modern_index_compare_cpu_prefinal_composite_frames} cpu_prefinal_overlay_frames={modern_index_compare_cpu_prefinal_overlay_frames} cpu_screen_builder_block_forced_blank={modern_index_compare_cpu_screen_builder_block_forced_blank} cpu_screen_builder_block_window={modern_index_compare_cpu_screen_builder_block_window} cpu_screen_builder_block_mosaic={modern_index_compare_cpu_screen_builder_block_mosaic} cpu_screen_builder_block_bg4={modern_index_compare_cpu_screen_builder_block_bg4} cpu_screen_builder_block_short_bg_layers={modern_index_compare_cpu_screen_builder_block_short_bg_layers} cpu_screen_builder_block_scroll={modern_index_compare_cpu_screen_builder_block_scroll} dynamic_palette_draws={modern_index_compare_dynamic_palette_draws} missing_variant_draws={modern_index_compare_missing_variant_draws} stable_preview_draws={modern_index_compare_stable_preview_draws} stable_effect_draws={modern_index_compare_stable_effect_draws} dynamic_material_draws={modern_index_compare_dynamic_material_draws} effect_material_draws={modern_index_compare_effect_material_draws} dynamic_material_fallback_draws={modern_index_compare_dynamic_material_fallback_draws} dynamic_material_fallback_instance_source_draws={modern_index_compare_dynamic_material_fallback_instance_source_draws} dynamic_material_fallback_brightness_draws={modern_index_compare_dynamic_material_fallback_brightness_draws} dynamic_material_fallback_policy_draws={modern_index_compare_dynamic_material_fallback_policy_draws} dynamic_material_fallback_missing_effect_draws={modern_index_compare_dynamic_material_fallback_missing_effect_draws} dynamic_material_fallback_unsupported_draws={modern_index_compare_dynamic_material_fallback_unsupported_draws} unsupported_material_draws={modern_index_compare_unsupported_material_draws} missing_art_draws={modern_index_compare_missing_art_draws} unkeyed_fallback_draws={modern_index_compare_unkeyed_fallback_draws} unkeyed_bg_fallback_draws={modern_index_compare_unkeyed_bg_fallback_draws} unkeyed_bg12_fallback_draws={modern_index_compare_unkeyed_bg12_fallback_draws} unkeyed_bg3_fallback_draws={modern_index_compare_unkeyed_bg3_fallback_draws} unkeyed_sprite_fallback_draws={modern_index_compare_unkeyed_sprite_fallback_draws} mixed_overlay_bg_effect_draws={modern_index_compare_mixed_overlay_bg_effect_draws} mixed_overlay_bg_effect_candidates={modern_index_compare_mixed_overlay_bg_effect_candidates} mixed_overlay_bg_effect_culled_invisible_main={modern_index_compare_mixed_overlay_bg_effect_culled_invisible_main} mixed_overlay_bg_effect_reject_complex_frame={modern_index_compare_mixed_overlay_bg_effect_reject_complex_frame} mixed_overlay_bg_effect_reject_complex_brightness={modern_index_compare_mixed_overlay_bg_effect_reject_complex_brightness} mixed_overlay_bg_effect_reject_complex_invalid_layer={modern_index_compare_mixed_overlay_bg_effect_reject_complex_invalid_layer} mixed_overlay_bg_effect_reject_complex_mosaic={modern_index_compare_mixed_overlay_bg_effect_reject_complex_mosaic} mixed_overlay_bg_effect_reject_complex_sub_window={modern_index_compare_mixed_overlay_bg_effect_reject_complex_sub_window} mixed_overlay_bg_effect_reject_complex_effect_bounds={modern_index_compare_mixed_overlay_bg_effect_reject_complex_effect_bounds} mixed_overlay_bg_effect_reject_complex_scanline_main={modern_index_compare_mixed_overlay_bg_effect_reject_complex_scanline_main} mixed_overlay_bg_effect_reject_complex_layer_window={modern_index_compare_mixed_overlay_bg_effect_reject_complex_layer_window} mixed_overlay_bg_effect_reject_complex_color_math={modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math} mixed_overlay_bg_effect_reject_complex_color_math_clip={modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_clip} mixed_overlay_bg_effect_reject_complex_color_math_subscreen={modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_subscreen} mixed_overlay_bg_effect_reject_complex_color_math_fixed_color={modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_fixed_color} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_cgram_mismatch={modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_cgram_mismatch} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap={modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg={modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_obj={modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_obj} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_deeper_chain={modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_deeper_chain} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front={modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_mixed_static_live_order={modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_mixed_static_live_order} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front_no_effect={modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front_no_effect} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front_complex={modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front_complex} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front_cgram_mismatch={modern_index_compare_mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front_cgram_mismatch} mixed_overlay_bg_effect_reject_cgram_mismatch={modern_index_compare_mixed_overlay_bg_effect_reject_cgram_mismatch} mixed_overlay_bg_effect_reject_overlap={modern_index_compare_mixed_overlay_bg_effect_reject_overlap}"
        );
    }
    if ppu_mode_summary {
        println!(
...
fn run_play_frame_with_run_what(
    game: &mut ZeldaState,
    input: u16,
    run_what: u8,
    frame: &mut [u8],
...
fn gpu_frame_from_ppu<'a>(
    ...
    GpuFrame {
        ...
        oam: &ppu.oam,
        mode: ppu.mode,
        bg: std::array::from_fn(|i| BgLayerRegs {
            h_scroll: ppu.bg_layer[i].h_scroll,
            v_scroll: ppu.bg_layer[i].v_scroll,
            tilemap_wider: ppu.bg_layer[i].tilemap_wider,
            tilemap_higher: ppu.bg_layer[i].tilemap_higher,
            tilemap_adr: ppu.bg_layer[i].tilemap_adr,
            tile_adr: ppu.bg_layer[i].tile_adr,
        }),
        obj: ObjRegs {
        ...
        windowsel_cm: ((ppu.windowsel >> 20) & 0xF) as u8,
...
fn run_replay_crash(args: &[String]) {
    ...
    for local_frame in 0..frames {
        ...
        let pre_frame_game = game.clone();
        let result = panic::catch_unwind(AssertUnwindSafe(|| {
            run_play_frame_with_run_what(&mut game, input, run_what, &mut frame, render_flags);
        }));
        if let Err(payload) = result {
            let panic_info = captured_panic_from(last_panic.clone(), payload);
            write_play_crash_report(
...
fn run_compare_libretro_oracle(args: &[String], default_oracle_name: Option<&str>) {
    ...
    for frame_index in 0..frames {
        ...
        run_play_frame(&mut game, input, &mut rust_frame, render_flags);
        let ports = game.zelda_debug_apu_write_ports();
        if trace_poly_sched {
            eprintln!(
...
fn run_dump_frame(args: &[String]) {
    ...
    for frame_no in 0..frames {
        ...
        run_play_frame(&mut game, input, &mut frame, render_flags);
    }
        ...
        if should_compare_modern_index {
                ...
                modern_variant_headless.as_ref()
            {
                if gpu_frame.mode == 7 {
                    ...
                    if let Some((trace_frame, trace_x, trace_y)) = variant_trace_pixel_env() {
                        if completed_frame == trace_frame {
                            let variant_atlas = variant_atlas
                                .as_ref()
                                .expect("variant atlas loaded for variant compare");
                            let plan = renderer::modern_variant_draw::compile_variant_draws(
                            ...
                            if traces.is_empty() {
                                eprintln!(
                                        "variant_pixel_trace frame={completed_frame} pixel=({trace_x}, {trace_y}) hits=0"
                                    );
                            } else {
                                for trace in traces {
                                    eprintln!(
                                            "variant_pixel_trace frame={completed_frame} pixel=({trace_x}, {trace_y}) {}",
                                            trace.describe()
                                        );
                                }
                            }
            ...
            if let Some(stats) = variant_stats {
                ...
                modern_index_compare_fallback_draws += u64::from(stats.fallback_draws);
                modern_index_compare_live_index_draws += u64::from(stats.live_index_draws);
                modern_index_compare_live_index_bg_draws += u64::from(stats.live_index_bg_draws);
                modern_index_compare_live_index_bg12_draws +=
                    u64::from(stats.live_index_bg12_draws);
                modern_index_compare_live_index_bg3_draws += u64::from(stats.live_index_bg3_draws);
                modern_index_compare_live_index_sprite_draws +=
                    u64::from(stats.live_index_sprite_draws);
                modern_index_compare_gpu_prefinal_base_frames +=
                    u64::from(stats.gpu_prefinal_base_frames);
                ...
                if !modern_index_compare_summary || mismatch != 0 {
                    if let Some(diff) = modern_diff.as_ref() {
                        println!(
                            "modern_index_compare frame={completed_frame} mode={mode_label} ppumode={} mismatch_px={mismatch} via={via} variant_draws={} fallback_draws={} live_index_draws={} live_index_bg_draws={} live_index_bg12_draws={} live_index_bg3_draws={} live_index_sprite_draws={} gpu_prefinal_base_frames={} direct_gpu_fallback_frames={} gpu_screen_builder_frames={} cpu_prefinal_composite_frames={} cpu_prefinal_overlay_frames={} cpu_screen_builder_block_forced_blank={} cpu_screen_builder_block_window={} cpu_screen_builder_block_mosaic={} cpu_screen_builder_block_bg4={} cpu_screen_builder_block_short_bg_layers={} cpu_screen_builder_block_scroll={} dynamic_palette_draws={} missing_variant_draws={} stable_preview_draws={} stable_effect_draws={} dynamic_material_draws={} effect_material_draws={} dynamic_material_fallback_draws={} dynamic_material_fallback_instance_source_draws={} dynamic_material_fallback_brightness_draws={} dynamic_material_fallback_policy_draws={} dynamic_material_fallback_missing_effect_draws={} dynamic_material_fallback_unsupported_draws={} unsupported_material_draws={} missing_art_draws={} unkeyed_fallback_draws={} unkeyed_bg_fallback_draws={} unkeyed_bg12_fallback_draws={} unkeyed_bg3_fallback_draws={} unkeyed_sprite_fallback_draws={} mixed_overlay_bg_effect_draws={} mixed_overlay_bg_effect_candidates={} mixed_overlay_bg_effect_culled_invisible_main={} mixed_overlay_bg_effect_reject_complex_frame={} mixed_overlay_bg_effect_reject_complex_brightness={} mixed_overlay_bg_effect_reject_complex_invalid_layer={} mixed_overlay_bg_effect_reject_complex_mosaic={} mixed_overlay_bg_effect_reject_complex_sub_window={} mixed_overlay_bg_effect_reject_complex_effect_bounds={} mixed_overlay_bg_effect_reject_complex_scanline_main={} mixed_overlay_bg_effect_reject_complex_layer_window={} mixed_overlay_bg_effect_reject_complex_color_math={} mixed_overlay_bg_effect_reject_complex_color_math_clip={} mixed_overlay_bg_effect_reject_complex_color_math_subscreen={} mixed_overlay_bg_effect_reject_complex_color_math_fixed_color={} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_cgram_mismatch={} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap={} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg={} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_obj={} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_deeper_chain={} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front={} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_mixed_static_live_order={} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front_no_effect={} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front_complex={} mixed_overlay_bg_effect_reject_complex_color_math_prefinal_overlap_bg_unrepresentable_front_cgram_mismatch={} mixed_overlay_bg_effect_reject_cgram_mismatch={} mixed_overlay_bg_effect_reject_overlap={} first_mismatch=({}, {}) classic_rgb=({},{},{}) modern_rgb=({},{},{})",
                            gpu_frame.mode,
                            stats.stable_draws,
                            stats.fallback_draws,
                            stats.live_index_draws,
...
fn compare_oracle_render_frame(
    ...
    draw_play_ppu_frame(&mut game_state, game_frame, pitch, PpuRenderFlags::empty());
    draw_play_ppu_frame(&mut snes_state, snes_frame, pitch, PpuRenderFlags::empty());
...
fn render_lockstep_frames_in_place(
    ...
    draw_play_ppu_frame(&mut oracle.game, game_frame, pitch, PpuRenderFlags::empty());
