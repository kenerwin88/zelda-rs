        ...
        Some(
            (0..count)
                .map(|write| LibretroApuPortWrite {
                    ...
                    smp_opcode_cycle_before: unsafe { value(write, 18) },
                    smp_opcode_cycle_after: unsafe { value(write, 19) },
...
pub(crate) struct LibretroApuPortWrite {
    ...
    pub(crate) smp_opcode_cycle_before: i32,
    pub(crate) smp_opcode_cycle_after: i32,
