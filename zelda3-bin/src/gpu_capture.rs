...
use crate::gpu_readback::{GpuReadbackRenderer, GpuRgbaReadbackFrame, OptionalGpuReadbackRenderer};
...
fn new_gpu_readback_renderer(width: u32, height: u32) -> GpuReadbackRenderer {
    GpuReadbackRenderer::new(width, height)
}
...
fn optional_gpu_readback_renderer(
    ...
    OptionalGpuReadbackRenderer::new(required, width, height)
}
